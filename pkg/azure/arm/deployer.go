...
func (d *deployer) Deploy(
	...
	deploymentsClient.UserAgent = fmt.Sprintf("%s; %s", deploymentsClient.UserAgent, userAgent())
...
func (d *deployer) doNewDeployment(
	...
	groupsClient.UserAgent = fmt.Sprintf("%s; %s", groupsClient.UserAgent, userAgent())
