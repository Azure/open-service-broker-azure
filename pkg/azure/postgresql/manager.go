...
// currently, when deleting ARM deployments, PostgreSQL servers don't get
...
// managing Azure Database for PostgresSQL
...
func (m *manager) DeleteServer(
	...
	serversClient := postgresql.NewServersClientWithBaseURI(
	...
	if err := <-errChan; err != nil {
		return fmt.Errorf("error deleting postgresql server: %s", err)
	}
