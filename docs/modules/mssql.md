...
| `connectionPolicy` | `string` | Refer [here](https://docs.microsoft.com/en-us/azure/sql-database/sql-database-connectivity-architecture#connection-policy) to specify a connection policy. Valid values are "Redirect", "Proxy", "Default" | N | |
